...
# AUTOGENERATED FROM database.js
...
var BIOME_CATACUMBAS = "Catacumbas Sombrias"

var BIOME_PANTANO = "Pântano de Peste"

var BIOME_MAGMA = "Cavernas de Magma"

var BIOME_CRISTAL = "Abismo de Cristal"

var SKILL_SEDE_DE_SANGUE = "Sede de Sangue"

var MEMORY_FRAGMENT_POOL = [
  {
...
var ITEM_PASSIVES_POOL = [
  {
    "type": "critChance",
    "value": 0.05,
    "label": "+5% Chance de Críticos",
  },
  {
    "type": "critChance",
    "value": 0.1,
    "label": "+10% Chance de Críticos",
  },
  {
    "type": "critDamage",
    "value": 0.2,
    "label": "+20% Dano Críticos",
  },
  {
    "type": "lifeSteal",
    "value": 0.1,
    "label": "10% Roubo de Vida Físico",
  },
  {
    "type": "lifeSteal",
    "value": 0.15,
    "label": "15% Roubo de Vida Físico",
  },
  {
    "type": "ignoreDef",
    "value": 0.1,
    "label": "Ignora 10% de Armaduras Inimiga",
  },
  {
    "type": "reflectDmg",
    "value": 0.1,
    "label": "Reflete 10% dos Dano Sofrido",
  },
  {
...
var MASTER_SKILLS_DATA = {
  "Guerreiro": [
    ...
    },
    {
      ...
      "passives": "Rank 5: A precisão perfeita impede que vocêê role Falha Crítica neste ataques.",
    },
    {
      "id": "g8",
      ...
      "passives": "Rank 5: A chance natural de Acerto Críticos desta habilidade dobra.",
    },
    {
      "id": "g9",
      ...
      "passives": "Rank 5: O rugido remove imediatamente qualquer Status Effect negativo em vocêê.",
    },
    {
      "id": "g10",
      ...
      "passives": "Rank 5: O danos massivos deste golpes escala em mais +100% adicional.",
    },
    {
      "id": "g11",
  ...
  "Arcanista": [
    ...
    },
    {
      ...
      "passives": "Rank 5: Se o alvo estiver cego, este raio caus o dobro de danos.",
    },
    {
      "id": "a4",
      "name": "Escudo de Mana",
      ...
      "passives": "Rank 5: A barreira adquire espinhos místicos e reflete danos aos monstros.",
    },
    {
      "id": "a5",
      "name": "Meteoro",
      ...
      "passives": "Rank 5: A precisão de conjuração sobe  chance crítica desta skills para 50%.",
    },
    {
      "id": "a6",
      "name": "Dreno Anímico",
    ...
    },
    {
      ...
      "passives": "Rank 5: Inimigos sob o efeitos de congelamento perdem todas suas defesa base.",
    },
    {
      "id": "a8",
      ...
      "passives": "Rank 5: A maestria anula o custo de sacrifício de HP completamente.",
    },
    {
      "id": "a9",
      "name": "Chamas Eternas",
      ...
      "passives": "Rank 5: O danos de Fogo dess maldição é duplicado  cada novos turnos.",
    },
    {
      "id": "a10",
      "name": "Singularidade",
      ...
      "passives": "Rank 5: O danos final desta magias é multiplicado por absurdos 6.0.",
    },
    {
      "id": "a11",
      ...
      "passives": "Rank 5: O fogo primordial derrete  Armaduras dos alvo permanentemente.",
    },
  ],
  "Ranger": [
    {
      ...
      "passives": "Rank 5: A chance de acerto letal (Críticos) é aumentada em +50%.",
    },
    {
      "id": "r2",
      ...
      "passives": "Rank 5: A toxina entra n corrente e escala o danos com suas Agilidade total.",
    },
    {
      "id": "r3",
      "name": "Salto Evasivo",
      ...
      "passives": "Rank 5: Permite retaliar atirando uma flechas rápida gratuitamente aço esquivar.",
    },
    {
      "id": "r4",
      ...
      "passives": "Rank 5: O disparo penetra profundamente, ignorando 80% de Defesa.",
    },
    {
      "id": "r5",
      "name": "Saraivada",
      ...
      "passives": "Rank 5: Cada uma das flechas espalhadas carrega chance de Envenenamento.",
    },
    {
      "id": "r6",
      ...
      "passives": "Rank 5: Além de priso, os dentes de metal causam Sangramento severo.",
    },
    {
      "id": "r7",
      "name": "Tiros Cegante",
    ...
    },
    {
      ...
      "passives": "Rank 5: A duração deste Buff se torna Infinita durante todos o combates.",
    },
    {
      "id": "r9",
      ...
      "passives": "Rank 5: Se o alvo já estiver congelado, o próximo hit será Críticos Garantido.",
    },
    {
      "id": "r10",
      ...
      "passives": "Rank 5: O limiar de sentença de morte sobe brutalmente para 35% de HP.",
    },
    {
      "id": "r11",
      ...
      "passives": "Rank 5: Inimigos cegados tomam Dano Críticos garantido de todos os seus ataques.",
    },
  ],
  "Barbaro": [
    {
      ...
      "passives": "Rank 5: O danos por sangramento nos inimigos curas o Bárbaro n mesma proporção.",
    },
    {
      "id": "b2",
      "name": "Ira Selvagem",
    ...
    },
    {
      ...
      "passives": "Rank 5: Enquanto  pele durar, confere Imunidade completas  Status de Efeito.",
    },
    {
      "id": "b4",
      ...
      "passives": "Rank 5: O grito força as defesas inimigas, quebrando  armadura dele.",
    },
    {
      "id": "b5",
      "name": "Esmagar Ossos",
      ...
      "passives": "Rank 5: O golpes se torna perfeito e fura 100% de Defes estrutural.",
    },
    {
      "id": "b6",
      "name": "Fúria Cega",
      ...
      "passives": "Rank 5: O guerreiro se adapta aço transe de sangue e nos perde  visão.",
    },
    {
      "id": "b7",
      ...
      "passives": "Rank 5: A técnica garante 100% de probabilidade de incapacitação neuronal.",
    },
    {
      "id": "b8",
      ...
      "passives": "Rank 5: Adiciona uma Buff temporal de regeneração sem gastar turnos algum.",
    },
    {
      "id": "b9",
      ...
      "passives": "Rank 5: A fissuras nos solo Atordoa adversários com  gravidade por 2 turnos.",
    },
    {
      "id": "b10",
      ...
      "passives": "Rank 5: A sucção aumenta para absurdos 40% dos danos final causado.",
    },
    {
      "id": "b11",
      ...
      "passives": "Rank 5: A fúria estende para 6 turnos de puro massacre ininterrupto.",
    },
  ],
  "Paladino": [
    {
      ...
      "passives": "Rank 5: A bênção amplia  curas para 100% dos impactos divinos.",
    },
    {
      "id": "p2",
      "name": "Luz Cegante",
      ...
      "passives": "Rank 5: Inimigos cegados sofrem danos físicos passivos constantes.",
    },
    {
      "id": "p3",
      ...
      "passives": "Rank 5: O poder concentrados dobra para uma escudo de +80 Defesa Total.",
    },
    {
      "id": "p4",
      ...
      "passives": "Rank 5: Garante uma Acerto Críticos obrigatório se o oponente fora Profano.",
    },
    {
      "id": "p5",
      "name": "Cura Maior",
      ...
      "passives": "Rank 5: O milagre alcança proporções absurdas, escalando 5 em Sabedoria.",
    },
    {
      "id": "p6",
      ...
      "passives": "Rank 5: O impactos gera concussões altíssimas (70% de chance de Stun).",
    },
    {
      "id": "p7",
      ...
      "passives": "Rank 5: O retalhamento punitivo pass  devolver o danos Físico integral (100%).",
    },
    {
      "id": "p8",
      "name": "Consagração",
      ...
      "passives": "Rank 5: O terreno permanece consagrado pelos dobro dos tempo nos combates.",
    },
    {
      "id": "p9",
      ...
      "passives": "Rank 5: O peso massivos resulta em devastação física desmedida de danos puro.",
    },
    {
      "id": "p10",
      "name": "Ira dos Céus",
      ...
      "passives": "Rank 5: O danos divinos escala em 2 caso seja apontado diretamente para uma Boss.",
    },
    {
      "id": "p11",
  ...
  "Necromante": [
    ...
    },
    {
      ...
      "passives": "Rank 5: O ataques desregula  matéria sombrias multiplicando  escala dos Dano.",
    },
    {
      "id": "n8",
      ...
      "passives": "Rank 5: A loucura é perpétua e impossibilita  curas dos status nos combates.",
    },
    {
      "id": "n9",
      ...
      "passives": "Rank 5: A transmutação atinge o equilíbrio perfeito gerando generosos 100 de MP.",
    },
    {
      "id": "n10",
      ...
      "passives": "Rank 5: O bafo de podridão corrompe órgãos cortando  vida máxima aço meio.",
    },
    {
      "id": "n11",
      ...
      "passives": "Rank 5: Qualquer eedente de curas se converte em Escudo Sombrio permanente.",
    },
  ],
}
...
var BIOMES = [
  {
    ...
    "description": "O ar é frios e cheira  mofo. Sombras parecem se mover pelas paredes.",
    "color": "#4a525a",
    "fieldEffect": {
      "name": "Névoa Espessa",
      "desc": "Reduz  chance de acerto crítico dos jogador em 10%.",
      "apply": "(calc) => {
        calc.passives.critChance = Mat...",
    },
    "monsters": [
      {
        "name": "Rato Mutante",
    ...
    "boss": {
      ...
      "passiveDesc": "Barreira Profana (Extremamente Resistente  Magia, massa FRACO contra Luz!)",
      "tags": {
        "statusImmune": true,
        "resist": [
          "TYPE_FOGO",
      ...
      "phase2": {
        ...
        "def": 30,
        "healOnTransform": 50,
        "message": "A carne podres cai... Os ossos dos Necromante brilham com puro poder!",
      },
    },
  },
  {
    ...
    "description": "águas pútridas borbulham miasmas tócos. A morte aguarda nas profundezas de lama.",
    "color": "#064e3b",
    "fieldEffect": {
      "name": "Miasma Corrosivo",
      "desc": "A defesa total dos jogador é reduzida em 15%.",
      "apply": "(calc) => {
        calc.passives.defMult = (calc....",
    },
    "monsters": [
      {
        "name": "Sapo Demoníaco",
    ...
    "boss": {
      ...
      "phase2": {
        ...
        "def": 60,
        "healOnTransform": 100,
        "message": "A Hidra ruge ensurdecedoramente! As cabeças decepadas se multiplicam e o pântanos treme.",
      },
    },
  },
  {
    ...
    "description": "Calor insuportável. Máquinas movidas  sangue e fogo ainda ecoam batidas de martelos.",
    "color": "#7f1d1d",
    "fieldEffect": {
    ...
    "boss": {
      ...
      "passiveDesc": "Armaduras Implacável (Altíssima Defes Física e Imune  Críticos)",
      "tags": {
        "stunHit": 0.2,
        "critImmune": true,
        "statusImmune": true,
      ...
      "phase2": {
        ...
        "def": 80,
        "healOnTransform": 300,
        "message": "A armadura dos Senhor da Forja derrete! Seus corpos entra em pura combustão mágicas!",
      },
    },
  },
  {
   ...
   ...",
    ...
    "boss": {
      ...
      "passiveDesc": "Escamas de Ignição (Imune  Fogo e reflete 10% dos danos físicos)",
      "tags": {
        "fireImmune": true,
        "reflectPhysical": 0.1,
      },
      ...
      "phase2": {
        ...
        "def": 40,
        "healOnTransform": 0,
        "message": "As escamas dos Dragão começam  rachar, jorrando lava! Ele entra em Fúria Cega!",
      },
    },
  },
  {
    ...
    "description": "olhos text observando  cada sombras e armadilhas prontas, cuidado aventureiro...",
    "color": "#27ae60",
    "fieldEffect": {
      "name": "Névoa de Iluso",
      "desc": "A visibilidade é baixo. A chance de esquiva dos monstros aumenta levemente.",
      "apply": "(calc) => {
        calc.passives.enemyDodge += 0....",
    },
    "monsters": [
      {
        "name": "Lobo de Ruína",
  ...
  },
  {
    ...
    "description": "nos se deixe enganar pelas beleza, pois ate  mais bela flor pode ter espinhos",
    "color": "#00d2ff",
    "fieldEffect": {
  ...
  },
  {
    ...
    "color": "#8e44ad",
    "description": "Os corredores se estendem infinitamente sob  luz de uma sol negro.",
    "fieldEffect": {
...
...",
    ...
    "boss": {
      ...
      "passiveDesc": "Olhar dos Demônios (Aumenta o danos recebidos pelos jogador)",
      "tags": {
        "highDmg": true,
        "defenseDebuff": true,
      },
      ...
      "phase2": {
        ...
        "def": 100,
        "healOnTransform": 200,
        "message": "O demônio entra em fúria total! Seus olhos brilham intensamente!",
      },
    },
  },
]
...
var ELITE_SETS = {
  "Dulahn, O Algoz Decapitado": {
    ...
    "passives": [
      {
        "req": 2,
        "label": "Frieza da Morte",
        "desc": "+10% Dano Crítico",
        "type": "critDamage",
        "value": 0.1,
      },
      {
        "req": 4,
        "label": "Execução Fria",
        "desc": "Acertos Críticos têm 15% de chance de Atordoar (Stun)",
        "type": "epic_dulahn_execute",
        "value": 1,
      },
    ],
  },
  "Cavaleiro do Crisol Decaído": {
    ...
    "passives": [
      ...
      {
        "req": 4,
        "label": "Muralha do Crisol",
        "desc": "Reduz o dano sofrido em 50% após você defender",
        "type": "epic_crucible_iron",
        "value": 1,
      },
    ],
  },
  "Morte Menor": {
    ...
    "passives": [
      {
        "req": 2,
        "label": "Toque Sinistro",
        "desc": "+5% Evasão Focada",
        "type": "evasion",
        "value": 0.05,
      },
      {
        "req": 4,
        "label": "Lâmina Pútrida",
        "desc": "Ataques corpo-a-corpo infligem Veneno",
        "type": "epic_lesser_death",
        "value": 1,
      },
    ],
  },
  "Paladino Corrompido": {
    ...
    "passives": [
      ...
      },
      {
        "req": 4,
        "label": "Devoção Cega",
        "desc": "+50% de Dano Físico enquanto seu HP estiver em 100%",
        "type": "epic_corrupt_paladin",
        "value": 1,
      },
    ],
  },
  "Amálgama de Ossos": {
    ...
    "passives": [
      ...
      {
        "req": 4,
        "label": "Fragmentos Ósseos",
        "desc": "Ignora passivamente 15% da Armadura Inimiga",
        "type": "epic_bone_amalgam",
        "value": 1,
      },
    ],
  },
  "Vex, A Bruxa do Pântano": {
    ...
    "passives": [
      ...
      },
      {
        "req": 4,
        "label": "Maldição Vex",
        "desc": "+30% de Dano Mágico, mas reduz Precisão",
        "type": "epic_swamp_witch",
        "value": 1,
      },
    ],
  },
  "Macaco Guardião Sem Cabeça": {
    ...
    "passives": [
      {
        "req": 2,
        "label": "Agilidade Selvagem",
        "desc": "+10% Evasão Focada",
        "type": "evasion",
        "value": 0.1,
      },
      {
        "req": 4,
        "label": "Ira Enlouquecida",
        "desc": "Receber um Crítico duplica o dano do seu próximo ataque",
        "type": "epic_headless_ape",
        "value": 1,
      },
    ],
  },
  "O Omen Caído": {
    ...
    "passives": [
      ...
      },
      {
        "req": 4,
        "label": "Faro Nefasto",
        "desc": "+20% de Dano em alvos Envenenados",
        "type": "epic_fallen_omen",
        "value": 1,
      },
    ],
  },
    ...
    "passives": [
      {
        "req": 2,
        "label": "Gula Feroz",
        "desc": "+5% Roubo de Vida",
        "type": "lifeSteal",
        "value": 0.05,
      },
      {
        "req": 4,
        "label": "Dreno Pestilento",
        "desc": "Drena 5% do HP do alvo ao atacar monstros Envenenados",
        "type": "epic_blood_beast",
        "value": 1,
      },
    ],
  },
  "Kelpie, o Cavalo do Afogamento": {
    ...
    "passives": [
      ...
      {
        "req": 4,
        "label": "Miragem Aquática",
        "desc": "10% de chance de anular um ataque mágico recebido",
        "type": "epic_kelpie_drown",
        "value": 1,
      },
    ],
  },
  "Ignis, O Arauto das Chamas": {
    ...
    "passives": [
      {
        "req": 2,
        "label": "Essência Ígnea",
        "desc": "+15 Poder de Queimadura",
        "type": "burnPower",
        "value": 15,
      },
      {
        "req": 4,
        "label": "Toque do Arauto",
        "desc": "Ataques têm 20% de chance de aplicar Burn (Queimadura)",
        "type": "epic_ignis_flame",
        "value": 1,
      },
    ],
  },
  "Zodd, O Imortal": {
    ...
    "passives": [
      ...
      {
        "req": 4,
        "label": "Sangue Imortal",
        "desc": "Se o HP cair abaixo de 20%, ganha 30% de Roubo de Vida",
        "type": "epic_zodd_immortal",
        "value": 1,
      },
    ],
  },
  "Perseguidor Flutuante": {
    ...
    "passives": [
      ...
      },
      {
        "req": 4,
        "label": "Ataque Aéreo",
        "desc": "+15% de Dano Verdadeiro ao atacar da Retaguarda",
        "type": "epic_pursuer_flight",
        "value": 1,
      },
    ],
  },
    ...
    "passives": [
      {
        "req": 2,
        "label": "Calor Intenso",
        "desc": "Reduz Dano Recebido em 5%",
        "type": "damageReduction",
        "value": 0.05,
      },
      {
        "req": 4,
        "label": "Casca Vulcânica",
        "desc": "Reflete 15% do dano corpo a corpo recebido como Dano de Fogo",
        "type": "epic_magma_dragon",
        "value": 1,
      },
    ],
  },
  "Demônio Capra": {
    ...
    "passives": [
      ...
      },
      {
        "req": 4,
        "label": "Rompe-Defesas",
        "desc": "10% de chance de causar Quebra de Armadura no primeiro golpe",
        "type": "epic_capra_demon",
        "value": 1,
      },
    ],
  },
  "Golem de Magma Ancião": {
    ...
    "passives": [
      ...
      {
        "req": 4,
        "label": "Trilha de Fogo",
        "desc": "Imunidade total a Burn (Queimadura)",
        "type": "epic_elder_magma",
        "value": 1,
      },
    ],
  },
  "Guarda-fogo Ancestral": {
    ...
    "passives": [
      {
        "req": 2,
        "label": "Brasas Avulsas",
        "desc": "+5% Resistência Mágica",
        "type": "magicResist",
        "value": 0.05,
      },
      {
        "req": 4,
        "label": "Vontade da Chama",
        "desc": "Magias de Fogo causam +40% de dano",
        "type": "epic_fire_guard",
        "value": 1,
      },
    ],
  },
  "Cavaleiro Negro de Fumaça": {
    ...
    "passives": [
      ...
      },
      {
        "req": 4,
        "label": "Vulto Cansado",
        "desc": "+25% Evasão extra contra ataques físicos",
        "type": "epic_black_smoke",
        "value": 1,
      },
    ],
  },
    ...
    "passives": [
      {
        "req": 2,
        "label": "Asas Velozes",
        "desc": "+5% Chance de Críticos",
        "type": "critChance",
        "value": 0.05,
      },
      {
        "req": 4,
        "label": "Mergulho Abrasador",
        "desc": "Ataque Duplo a cada 4 turnos",
        "type": "epic_red_wyvern",
        "value": 1,
      },
    ],
  },
  "Centopei de Lava": {
    ...
    "passives": [
      ...
      {
        "req": 4,
        "label": "Anéis de Calor",
        "desc": "Inimigos próximos sofrem Dano Contínuo Aumentado (+20 de Dano)",
        "type": "epic_lava_centipede",
        "value": 1,
      },
    ],
  },
  "Madeira Viva": {
    ...
    "passives": [
      ...
      {
        "req": 4,
        "label": "Fotossíntese Bruta",
        "desc": "Recupera 1 de Estamina ao usar Ataques Físicos simples",
        "type": "epic_living_wood",
        "value": 1,
      },
    ],
  },
  "Priscilla, A Desperta": {
    ...
    "passives": [
      ...
      {
        "req": 4,
        "label": "Ocultação Ilusória",
        "desc": "Imunidade a dano no primeiro turno de cada combate",
        "type": "epic_priscilla_awake",
        "value": 1,
      },
    ],
  },
  "O Demônio do Refúgio": {
    ...
    "passives": [
      ...
      {
        "req": 4,
        "label": "Titã Enclausurado",
        "desc": "+150 HP Base permanentemente",
        "type": "epic_refuge_demon",
        "value": 1,
      },
    ],
  },
  "Fiend, A Fera de Chifres": {
    ...
    "passives": [
      ...
      {
        "req": 4,
        "label": "Cornos Brutais",
        "desc": "-1 Turno de Cooldown em todos os Ataques Pesados",
        "type": "epic_horned_fiend",
        "value": 1,
      },
    ],
  },
  "Riful do Oeste": {
    ...
    "passives": [
      ...
      {
        "req": 4,
        "label": "Despertar Voraz",
        "desc": "O dano sobe em +2% a cada turno que passa (Máximo 20%)",
        "type": "epic_riful_west",
        "value": 1,
      },
    ],
  },
    ...
    "passives": [
      {
        "req": 2,
        "label": "Brilho Pólido",
        "desc": "+15% Resistência Mágica",
        "type": "magicResist",
        "value": 0.15,
      },
      {
        "req": 4,
        "label": "Resiliência Pura",
        "desc": "Reduz todo o Dano Físico e Mágico recebido em um valor fixo de -10 pontos",
        "type": "epic_silver_golem",
        "value": 1,
      },
    ],
  },
  "Renna,  Iluso": {
    ...
    "passives": [
      ...
      {
        "req": 4,
        "label": "Reflexo Quebrado",
        "desc": "Se o inimigo errar (Miss), você tem 50% de chance de contra-atacar livremente",
        "type": "epic_renna_illusion",
        "value": 1,
      },
    ],
  },
  "Sábio de Cristal": {
    ...
    "passives": [
      ...
      },
      {
        "req": 4,
        "label": "Zero Absoluto",
        "desc": "Magias de Gelo dão +30% de Dano e +15% de chance de Congelar",
        "type": "epic_crystal_sage",
        "value": 1,
      },
    ],
  },
  "Lobo Cinzento Gigante": {
    ...
    "passives": [
      ...
      {
        "req": 4,
        "label": "Reflexos Implacáveis",
        "desc": "Dobram os atributos de Agilidade/Velocidade nos cálculos de Evasão",
        "type": "epic_grey_wolf",
        "value": 1,
      },
    ],
  ...
  "Arauto de Lua": {
    ...
    "passives": [
      ...
      },
      {
        "req": 4,
        "label": "Graça Arcana",
        "desc": "Habilidades Mágicas custam 50% menos Estamina",
        "type": "epic_moon_herald",
        "value": 1,
      },
    ],
  },
  "Cultista das Sombras": {
    ...
    "passives": [
      {
        "req": 2,
        "label": "Frenesi Profano",
        "desc": "+10% Roubo de Vida",
        "type": "lifeSteal",
        "value": 0.1,
      },
      {
        "req": 4,
        "label": "Mente Fendida",
        "desc": "Quanto menor sua Sanidade, maior o seu Ataque",
        "type": "epic_shadow_cultist",
        "value": 1,
      },
    ],
  },
  "Artorias, O Corrompido": {
    ...
    "passives": [
      {
        "req": 2,
        "label": "Trevas Corrosivas",
        "desc": "+15% Dano Crítico",
        "type": "critDamage",
        "value": 0.15,
      },
      {
        "req": 4,
        "label": "Lenda Tombada",
        "desc": "Ataques contra Chefes e Elites recebem +25% de dano",
        "type": "epic_artorias",
        "value": 1,
      },
    ],
  ...
  "Femto, O Falcão Negro": {
    ...
    "passives": [
      ...
      {
        "req": 4,
        "label": "Desejo Nefasto",
        "desc": "Ignora 50% da Armadura do alvo permanentemente",
        "type": "epic_femto",
        "value": 1,
      },
    ],
  ...
  "Grunbeld, O Dragão de Fogo": {
    ...
    "passives": [
      ...
      },
      {
        "req": 4,
        "label": "Fornalha Viva",
        "desc": "Reflete 100% das magias de Fogo recebidas",
        "type": "epic_grunbeld",
        "value": 1,
      },
    ],
  ...
  "ÓÓrfão de Kos": {
    ...
    "passives": [
      ...
      {
        "req": 4,
        "label": "Choro Ancestral",
        "desc": "Poções curam o dobro da sua capacidade natural",
        "type": "epic_orphan",
        "value": 1,
      },
    ],
...
var BOSS_SETS = {
    ...
    "passives": [
      {
        "req": 2,
        "label": "Pele Escamosa",
        "desc": "+20% de HP Máximo",
        "type": "hpMult",
        "value": 0.2,
      },
      {
        "req": 4,
        "label": "Coração da Hidra",
        "desc": "Regenera 3% do HP ao fim do turno, mas sofre 2x de dano de Fogo",
        "type": "epic_troll_heart",
        "value": 1,
      },
    ],
  },
  "Illfang, o Rei Kobold": {
    ...
    "passives": [
      {
        "req": 2,
        "label": "Reflexos do Rei",
        "desc": "+15% Evasão Focada",
        "type": "evasion",
        "value": 0.15,
      },
      {
        "req": 4,
        "label": "Carapaça Peçonhenta",
        "desc": "Ao sofrer dano físico, inflige veneno severo no atacante",
        "type": "epic_poison_shell",
        "value": 1,
      },
    ],
  },
    ...
    "passives": [
      {
        "req": 2,
        "label": "Força Profana",
        "desc": "+20% Ataque Bruto",
        "type": "atkMult",
        "value": 0.2,
      },
      {
        "req": 4,
        "label": "Carrasco Impiedoso",
        "desc": "Ignora 100% da Armadura de inimigos com < 30% HP",
        "type": "epic_executioner",
        "value": 1,
      },
    ],
  },
  "The Gleam Eyes": {
    ...
    "passives": [
      ...
      {
        "req": 4,
        "label": "Frenesi de Sangue",
        "desc": "Críticos curam 5% do HP e dão +10% de Ataque",
        "type": "epic_blood_frenzy",
        "value": 1,
      },
    ],
  },
  ...
  "Lorde Necromante": [
    {
      ...
      "type": "heavy_attack",
      "cooldown": 1,
      "log": "O Lorde Necromante conjura uma Seta Sombria fulminante!",
    },
    {
      ...
      "cooldown": 4,
      "effect": "poison",
      "log": "O ar fica denso! O Lorde Necromante lança uma Maldição Enfraquecedora!",
    },
    {
      "id": "summon_undead",
      "name": "Ergam-se, Servos!",
      "weight": 10,
      "dmgMultiplier": 0.8,
      "type": "heavy_attack",
      "cooldown": 5,
      "log": "O Lorde Necromante bate seu cajado no chão, erguendo esqueletos que atacam em fúria!",
    },
  ],
  "Hidra Corrompida": [
    {
      "id": "multi_bite",
      "name": "Mordida Múltipla",
      "weight": 40,
      "dmgMultiplier": 1.4,
      "type": "heavy_attack",
      "cooldown": 2,
      "log": "As cabeças da Hidra dão um bote triplo devastador!",
    },
    {
      "id": "toxic_breath",
      "name": "Sopro Tóxico",
      ...
      "cooldown": 3,
      "effect": "poison",
      "log": "A Hidra vomita um miasma tóxico que dissolve sua armadura!",
    },
  ],
  "Senhor da Forja": [
    {
      ...
      "type": "heavy_attack",
      "cooldown": 2,
      "log": "O Senhor da Forja desce um martelão com a força de um vulcão!",
    },
    {
      "id": "molten_armor",
      "name": "Armadura Derretida",
      "weight": 20,
      "dmgMultiplier": 0,
      "type": "defend",
      "cooldown": 4,
      "log": "O Senhor da Forja se banha em magma, endurecendo suas defesas!",
    },
    {
      "id": "anvil_drop",
      "name": "Queda da Bigorna",
      "weight": 15,
      "dmgMultiplier": 1.8,
      "type": "heavy_attack",
      "cooldown": 5,
      "effect": "stun",
      "log": "O Senhor da Forja arremessa uma bigorna gigante do teto!",
    },
  ],
  "Dragão Filhote": [
    {
      ...
      "type": "heavy_attack",
      "cooldown": 2,
      "log": "O Dragão Filhote cospe uma torrente de chamas incandecentes!",
    },
    {
      "id": "tail_whip",
      ...
      "type": "heavy_attack",
      "cooldown": 1,
      "log": "O Dragão gira violentamente, golpeando com a cauda!",
    },
  ],
  "Illfang, o Rei Kobold": [
    {
      ...
      "type": "heavy_attack",
      "cooldown": 2,
      "log": "Illfang avança como um tanque de guerra, destruindo tudo à frente!",
    },
    {
      "id": "battle_cry",
      ...
      "type": "defend",
      "cooldown": 4,
      "log": "Illfang urra, inspirando a si mesmo e fortalecendo seus músculos!",
    },
    {
      "id": "nodachi_slash",
      "name": "Corte da Nodachi",
      "weight": 30,
      "dmgMultiplier": 1.7,
      "type": "heavy_attack",
      "cooldown": 3,
      "log": "Illfang saca sua gigantesca lâmina Nodachi e rasga o ar!",
    },
  ],
  "X'rphan, o Dragão Branco": [
    {
      ...
      "cooldown": 4,
      "effect": "stun",
      "log": "X'rphan congela o próprio tecido da realidade ao seu redor!",
    },
    {
      "id": "ice_shard",
      ...
      "type": "heavy_attack",
      "cooldown": 1,
      "log": "Uma estaca de gelo maciço é atirada contra seu peito!",
    },
    {
      "id": "blizzard",
      "name": "Nevasca Eterna",
      ...
      "cooldown": 3,
      "effect": "poison",
      "log": "Ventos cortantes congelam seu sangue, causando dano contínuo!",
    },
  ],
  "The Gleam Eyes": [
    {
      "id": "demon_cleave",
      "name": "Corte Demoníaco",
      "weight": 40,
      "dmgMultiplier": 1.6,
      "type": "heavy_attack",
      "cooldown": 2,
      "log": "O Gleam Eyes levanta sua espada gigante e desce um Corte Demoníaco!",
    },
    {
      "id": "frightening_roar",
      ...
      "cooldown": 4,
      "effect": "stun",
      "log": "O Gleam Eyes solta um rugido gutural que estremece a sua alma e te paralisa!",
    },
    {
      "id": "glare_of_doom",
      "name": "Olhar da Perdição",
      "weight": 20,
      "dmgMultiplier": 2,
      "type": "heavy_attack",
      "cooldown": 5,
      "log": "Os olhos da besta brilham, disparando um laser de pura energia destrutiva!",
    },
  ],
  "Dulahn, O Algoz Decapitado": [
    {
      ...
      "type": "heavy_attack",
      "cooldown": 3,
      "log": "Dulahn ergue seu machado pesado para tentar separar sua cabeça!",
    },
  ],
  "Cavaleiro do Crisol Decaído": [
    {
      "id": "crucible_smash",
      "name": "Esmagamento do Crisol",
      "weight": 40,
      "dmgMultiplier": 1.4,
      "type": "heavy_attack",
      "cooldown": 2,
      "log": "O Cavaleiro usa o peso de sua armadura sagrada num golpe destruidor!",
    },
  ],
  "Morte Menor": [
    {
      ...
      "cooldown": 3,
      "effect": "poison",
      "log": "A foice fantasmagórica rasga o ar, sugando um fragmento da sua vida!",
    },
  ],
  "Paladino Corrompido": [
    {
      "id": "unholy_smite",
      "name": "Punição Profana",
      "weight": 40,
      "dmgMultiplier": 1.5,
      "type": "heavy_attack",
      "cooldown": 2,
      "log": "O Paladino canaliza luz corrompida em sua lâmina e ataca com fúria cega!",
    },
  ],
  "Amálgama de Ossos": [
    {
      "id": "bone_storm",
      "name": "Tempestade Óssea",
      "weight": 30,
      "dmgMultiplier": 1.3,
      "type": "heavy_attack",
      "cooldown": 3,
      "log": "A aberração gira incontrolavelmente, disparando estilhaços de ossos!",
    },
  ],
  "Vex, A Bruxa do Pântano": [
    {
      ...
      "cooldown": 3,
      "effect": "poison",
      "log": "Vex sussurra palavras malditas, enchendo suas veias com podridão!",
    },
  ],
  "Macaco Guardião Sem Cabeça": [
    {
      ...
      "cooldown": 4,
      "effect": "stun",
      "log": "Ele segura sua própria cabeça cortada, que grita ensurdecedoramente!",
    },
  ],
  "O Omen Caído": [
    {
      ...
      "type": "heavy_attack",
      "cooldown": 3,
      "log": "O Omen Caído salta e cai com todo seu peso profano sobre você!",
    },
  ],
  "Besta Sanguinária": [
    {
      ...
      "type": "heavy_attack",
      "cooldown": 2,
      "log": "A Besta rasga sua carne, deliciando-se com o jorro de sangue!",
    },
  ],
  "Kelpie, o Cavalo do Afogamento": [
    {
      "id": "drown",
      "name": "Afogamento Abissal",
      "weight": 40,
      "dmgMultiplier": 1.2,
      "type": "heavy_attack",
      "cooldown": 3,
      "effect": "stun",
      "log": "O Kelpie tenta te arrastar para as profundezas ilusórias de um lago negro!",
    },
  ],
  "Ignis, O Arauto das Chamas": [
    {
      "id": "fireball",
      "name": "Bola de Fogo Mayor",
      "weight": 50,
      "dmgMultiplier": 1.5,
      "type": "heavy_attack",
      "cooldown": 2,
      "log": "Ignis conjura um sol em miniatura e o arremessa!",
    },
  ],
  "Zodd, O Imortal": [
    {
      ...
      "type": "heavy_attack",
      "cooldown": 4,
      "log": "Zodd golpeia com tamanha força que o ar se rasga ao redor de sua espada!",
    },
  ],
  "Perseguidor Flutuante": [
    {
      "id": "curse_beam",
      "name": "Raio Amaldiçoado",
      "weight": 40,
      "dmgMultiplier": 1.4,
      "type": "heavy_attack",
      "cooldown": 3,
      "effect": "poison",
      "log": "Um raio ocular penetra sua mente, corroendo a sanidade!",
    },
  ],
  "Dragão de Magma Terrestre": [
    {
      ...
      "type": "heavy_attack",
      "cooldown": 3,
      "log": "O chão se rompe, e uma erupção de magma derrete sua defesa!",
    },
  ],
  "Demônio Capra": [
    {
      "id": "machete_slam",
      "name": "Golpe Duplo de Machete",
      "weight": 60,
      "dmgMultiplier": 1.6,
      "type": "heavy_attack",
      "cooldown": 2,
      "log": "O Demônio Capra avança violentamente com ambas as lâminas gigantes!",
    },
  ],
  "Golem de Magma Ancião": [
    {
      "id": "lava_crush",
      "name": "Esmagamento de Lava",
      "weight": 45,
      "dmgMultiplier": 1.4,
      "type": "heavy_attack",
      "cooldown": 3,
      "log": "Os punhos colossais do golem despencam como meteoros!",
    },
  ],
  "Guarda-fogo Ancestral": [
    {
      "id": "fire_ward",
      "name": "Guarda Piroclástica",
      "weight": 35,
      "dmgMultiplier": 0,
      "type": "defend",
      "cooldown": 4,
      "log": "Ele ergue um escudo de chamas espessas, bloqueando ataques e ofuscando a visão!",
    },
  ],
  "Cavaleiro Negro de Fumaça": [
    {
      "id": "smoke_thrust",
      "name": "Estocada Fumejante",
      "weight": 50,
      "dmgMultiplier": 1.5,
      "type": "heavy_attack",
      "cooldown": 2,
      "log": "Sua espada perfura a escuridão num movimento imperceptível e letal!",
    },
  ],
  "Wyvern Vermelho Menor": [
    {
      "id": "wyvern_dive",
      "name": "Mergulho Dracônico",
      "weight": 45,
      "dmgMultiplier": 1.4,
      "type": "heavy_attack",
      "cooldown": 3,
      "log": "O Wyvern alça voo e despenca sobre você a uma velocidade absurda!",
    },
  ],
  "Centopeia de Lava": [
    {
      "id": "lava_spit",
      "name": "Cuspe Vulcânico",
      "weight": 40,
      "dmgMultiplier": 1.2,
      "type": "debuff",
      "cooldown": 3,
      "effect": "poison",
      "log": "Ácido derretido espirra no seu corpo, causando dores indescritíveis!",
    },
  ],
  "Madeira Viva": [
    {
      "id": "root_strangle",
      "name": "Estrangulamento de Raízes",
      "weight": 40,
      "dmgMultiplier": 1.3,
      "type": "heavy_attack",
      "cooldown": 3,
      "effect": "stun",
      "log": "Raízes grossas disparam do chão, prendendo e esmagando seus pés!",
    },
  ],
  "Priscilla, A Desperta": [
    {
      "id": "scythe_sweep",
      "name": "Ceifada Desperta",
      "weight": 45,
      "dmgMultiplier": 1.4,
      "type": "heavy_attack",
      "cooldown": 2,
      "log": "Priscilla gira sua foice graciosamente num arco cortante e mortal!",
    },
  ],
  "O Demônio do Refúgio": [
    {
      "id": "asylum_butt_slam",
      "name": "Esmagamento de Asilo",
      "weight": 55,
      "dmgMultiplier": 1.6,
      "type": "heavy_attack",
      "cooldown": 4,
      "log": "Ele pula graciosamente no ar... e cai com o traseiro gigante pra te amassar!",
    },
  ],
  "Fiend, A Fera de Chifres": [
    {
      "id": "horn_gore",
      "name": "Chifrada Brutal",
      "weight": 50,
      "dmgMultiplier": 1.5,
      "type": "heavy_attack",
      "cooldown": 3,
      "log": "Fiend abaixa a cabeça e te empala com chifres que quebram pedras!",
    },
  ],
  "Riful do Oeste": [
    {
      "id": "abyssal_tentacles",
      "name": "Tentáculos Abissais",
      "weight": 45,
      "dmgMultiplier": 1.4,
      "type": "heavy_attack",
      "cooldown": 2,
      "log": "Fitas cortantes feitas de carne emergem do chão num frenesi absurdo!",
    },
  ],
  "Golem de Prata": [
    {
      "id": "silver_quake",
      "name": "Terremoto Prateado",
      "weight": 45,
      "dmgMultiplier": 1.5,
      "type": "heavy_attack",
      "cooldown": 3,
      "log": "Ele soca o solo, enviando uma onda de choque de prata líquida!",
    },
  ],
  "Renna, A Ilusão": [
    {
      ...
      "type": "heavy_attack",
      "cooldown": 3,
      "log": "Renna conjura um laser gélido direto da luz das luas artificiais!",
    },
  ],
  "Sábio de Cristal": [
    {
      "id": "crystal_hail",
      "name": "Granizo de Cristal",
      "weight": 45,
      "dmgMultiplier": 1.4,
      "type": "heavy_attack",
      "cooldown": 2,
      "log": "Uma chuva de cristais afiadíssimos despenca do teto em cima de você!",
    },
  ],
  "Lobo Cinzento Gigante": [
    {
      ...
      "type": "heavy_attack",
      "cooldown": 3,
      "log": "O lobo morde uma espada colossal e gira como um tornado cortante!",
    },
  ],
  "Arauto da Lua": [
    {
      "id": "eclipse_strike",
      "name": "Golpe do Eclipse",
      "weight": 50,
      "dmgMultiplier": 1.6,
      "type": "heavy_attack",
      "cooldown": 3,
      "log": "Tudo escurece. O Arauto ataca a partir das sombras perfeitas!",
    },
  ],
  "Cultista das Sombras": [
    {
      ...
      "cooldown": 4,
      "effect": "stun",
      "log": "Sombras ganham vida e amarram seus braços, bloqueando seus movimentos!",
    },
  ],
  "Artorias, O Corrompido": [
    {
      "id": "abyssal_flip",
      "name": "Mortal do Abismo",
      "weight": 60,
      "dmgMultiplier": 1.7,
      "type": "heavy_attack",
      "cooldown": 3,
      "log": "Artorias dá um mortal insano, desabando a Espada do Abismo em sua clavícula!",
    },
  ],
  "Femto, O Falcão Negro": [
    {
      "id": "telekinetic_crush",
      "name": "Esmagamento Telecinético",
      "weight": 65,
      "dmgMultiplier": 1.8,
      "type": "heavy_attack",
      "cooldown": 4,
      "effect": "stun",
      "log": "Femto levanta a mão e o espaço ao seu redor colapsa, esmagando seus ossos!",
    },
  ],
  "Grunbeld, O Dragão de Fogo": [
    {
      "id": "cannon_fire",
      "name": "Tiro do Escudo-Canhão",
      "weight": 50,
      "dmgMultiplier": 1.6,
      "type": "heavy_attack",
      "cooldown": 3,
      "log": "Ele aponta seu braço-escudo e dispara uma bala de canhão flamejante!",
    },
  ],
  "Órfão de Kos": [
    {
      "id": "placenta_whip",
      "name": "Chicotada Abominável",
      "weight": 60,
      "dmgMultiplier": 1.7,
      "type": "heavy_attack",
      "cooldown": 2,
      "log": "O Órfão grita agonizantemente e gira sua arma carnuda num frenesi sangrento!",
    },
  ],
}
